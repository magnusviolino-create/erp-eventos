...
const ProfilePage: FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 md:p-12 transition-colors duration-300">
            <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-colors duration-300">
                <div className="p-8">
                    ...
                    {success && (
                        <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 text-green-700 dark:text-green-400 rounded-r">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="border-t border-gray-100 dark:border-gray-700 pt-6 mt-6">
                            <h3 className="text-lg font-medium text-gray-800 dark:text-white mb-4">Alterar Senha</h3>
                            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Deixe em branco para manter a senha atual.</p>
                        ...
                        <div className="flex justify-end pt-6 gap-4">
                            <button
                                type="button"
                                onClick={() => navigate('/dashboard')}
                                className="px-6 py-2.5 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-semibold rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-all border border-gray-300 dark:border-gray-600"
                            >
                                Cancelar
                            </button>
                            <button
